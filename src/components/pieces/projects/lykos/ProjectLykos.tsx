...
export default function ProjectLykos() {
  return (
    <HomePanelProject
        ...
        about={
          <>
            This project started life as a fully integrated group management system with a built-in application system.
            However, after going dormant, it was re-vitalised, as a streamlined community management toolchain,
            capable of integrating heavily with the popular chat and VoIP service <a href="https://discord.com/" >Discord</a>.
            ...
            - Node.js (on both web servers)<br/>
            - Express.js (on both web servers)<br/>
            - Discord.js<br/>
