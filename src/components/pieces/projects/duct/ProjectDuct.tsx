    ...
    <HomePanelProject
        ...
        about={
          <>
            ...
            Much like Search Companion, this package was also designed for use in my current workplace, where it's used to speed up the process of producing drainage reports.
            It extracts coloured lines used by water companies to denote the location of water mains and sewers on a given map.
            It allows the user to transplant those lines onto a map of their choosing, allowing the user to perform the relevant alignments.<br/>
            <br/>
            ...
            The end result is an image that contains the lines sourced from the water company's map combined with the map supplied by the user.
            This image is placed into a template PDF which can be used to produce a full report.<br/>
            <br/>
            Also worth mentioning is that it is maintained via an&nbsp;
            <a href="https://github.com/IronicPickle/update-server" >update server</a>
            &nbsp;running Node.js, that allows the client to perform regular update checks.<br/>
            <br/>
